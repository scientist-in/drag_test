...
var numTiles  = 15;    // Number of tiles to initially populate the grid with
...
function createTile() {
  ...
  // var rowspan = fixedSize || oneColumn ? 1 : Math.floor(Math.random() * 3) + 1;
  // rowspan = 2
  var element = $("<div></div>").addClass("tile").html(label++);
  // var d3image = $('<img src="http://www.excel-easy.com/data-analysis/images/charts/column-chart.png"/>');
